...
$sql = "SELECT * FROM Pharmacist WHERE SSN = '$SSNold'";
...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    ...
    $sql="UPDATE Pharmacist SET SSN='$SSNnew', Names='$Names', PharmacyID='$PharmacyID'  
         WHERE SSN='$SSNold'";
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="SSN" id="SSN" value="<?php echo $SSNold?>" placeholder="Enter your SSN" required><br>
