...
if($_SESSION['Usertype']=='supervisor'){
    ...
    <body>
                    ...
                    <?php while($row = $result->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <?php if($_SESSION['Usertype'] == "supervisor"){ ?>
                                <td class="action"><a href='/App/update/edit_inventory.php?PharmacyID=<?php echo $row["PharmacyID"]?>'>Edit</a></td><?php }?>
                        </tr>
                    <?php } ?>
        ...
        <div class="pages">
            ...
            echo '<a class="page" href = "view_inventory.php?page=' . $page . '">' . $page . ' </a> ';  
